...
export const DashProvider = ({ children }) => {
  ...
  return (
    <dashContext.Provider value={{
      ...
      NPName, setNPName, setSavingAccounts, setClientBalance, getNametoNav, getEveryAcc, ChangeEmail
    }}>
      {children}

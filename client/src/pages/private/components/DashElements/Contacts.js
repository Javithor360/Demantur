  ...
  return (
    <div className="contacts-main-div h-100 flex justify-between">
      <div className='divs-contact contacts-big-div  w-[60%]'>
        ...
        <div className={` w-[80%] mx-auto my-6 h-[80%] ${true === true && ' flex justify-center items-center'}`}>
          <div className=''><IconChargin className='loading-icon animate-spin-custom h-[6rem] w-[6rem]' /></div>
        </div>
      </div>

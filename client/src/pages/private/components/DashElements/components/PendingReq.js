...
export const PendingReq = () => {
    ...
    return (
        <>
            <span className='mt-5 text-[#606470]'>Sus solicitudes hechas</span>
            {
                PedingFriendReq.length !== 0 ?
                    PedingFriendReq.map((el, i) => {
                        return (
                            <div key={i} className="bg-[#FBFBFB] w-full flex justify-between mt-5 p-3 border border-[#707070] rounded-md">
                                <>
                                    <div className="flex">
                                        <div className="mr-7">
                                            {/* foto: {el.Photo} */}
                                        ...
                                        <div className="vl-2"><hr /></div>
                                    </div>
                                    <div className="flex items-center">
                                        <button className="px-3 py-2 outline-none border-none rounded-md bg-[#E24B3B] text-white" onClick={() => { CancelFriendReq(el) }}>Cancelar</button>
                                    </div>
                                </>
                            </div>
                        )

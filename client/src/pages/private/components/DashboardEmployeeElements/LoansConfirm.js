...
export const LoanConfirm = ({props, setActive}) => {
  const closeButton = () => {
    try {
        setActive(false);
    } catch (error) {
  ...
  return (
    <div className='h-[30rem] w-[50rem]'>
        ...
        <div className='w-[80%] mx-auto mt-5 flex flex-row justify-center items-center'>
          <button className='text-white rounded-lg border-none outline-none bg-[#455FB9] hover:bg-[#4f6acb] px-[1rem] py-[.5rem] mr-5'>Confirmar</button>

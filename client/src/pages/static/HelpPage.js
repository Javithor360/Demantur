...
export const HelpPage = () =>{
    return(
        ...
        <div class="accordion">
            <div class="contentBx">
                <div class="label">¿Cómo abro una cuenta bancaria?</div>
                <div class="content">
            ...
            <div class="contentBx">
                <div class="label">Tarjeta robada o extraviada</div>
                <div class="content">
            ...
            <div class="contentBx">
                <div class="label">Ver estados de cuenta</div>
                <div class="content">
            ...
            <div class="contentBx">
                <div class="label">¿Cómo pagar mi tarjeta de crédito?</div>
                <div class="content">
            ...
            <div class="contentBx">
                <div class="label">¿Como solicitar una tarjeta crédito?</div>
                <div class="content">

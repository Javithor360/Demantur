    ...
    <>
      ...
      <div className="boxs-wrap">
        <div className="boxs">
          ...
          <br />
          <p className="info2">
            si tu empresa aún no tiene una cuenta con nosotros, cotratala de
        ...
        <div className="boxs">
          ...
          <br />
          <p className="info2">
            La mejor opcion en cuanto a administracion de tu estado bancario,
            todo desde la comodidad de tu hogar sin tener que ira un banco
          </p>
          <div className="boton-position">
            <button class="custom-btn btn-15">Iniciar sesion</button>
            <button class="custom-btn btn-15">Registrarce</button>

...
const { testDB, getUserId, getGlobalInfo, getFriendsReq, addFriendRequest, CancelPendingFr, AcceptFriend,DeclineFriend } = require('../controllers/DashboardNUController');
